...
- Если простой рекламы не стоит добавлять очень много в игру, так как игроку может это надоесть, то в случае рекламы за вознаграждение можно, и даже нужно добавлять больше точек входа, потому что игроки любят, когда им предоставляют выбор, а так же предлагают игровые блага. В данной игре можно сделать следующие точки входа рекламы за вознаграждение: После смерти можно предложить воскреснуть за просмотр рекламы, а так же увеличить полученные очки в 2 раза. В одном из видео мы делали кнопку, которая просто активирует рекламу за вознаграждение в главном меню. Можно развить идею, добавить в игру валюту и дать ограничение игроку: за сутки у игрока будет возможность 5 раз нажать на кнопку, и после нажатия он может получить или не получить награду. Будет что-то вроде колеса фортуны. Дальше можно пофантазировать, что еще будет возможным в будущем. Например, если мы добавим валюту, то нужно добавить магазин, в котором могут продавать
